...
not clipped. Enemy animation crop boxes should be rechecked against the source
sheet when changed so their visible centers remain consistent across all frames
for each enemy type.
