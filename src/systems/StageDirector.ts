...
export function createDefaultStage(): StageEvent[] {
  return [
    ...
    { atMs: 10000, type: 'wave', enemyType: 'straight', count: 6 },
    { atMs: 15000, type: 'wave', enemyType: 'heavy', count: 2 },
    { atMs: 21000, type: 'wave', enemyType: 'sway', count: 6 },
    { atMs: 28000, type: 'boss' },
  ];
}
