...
export const BOSS_CLEAR_OVERLAY_FADES_DEFEAT_BODY = false;
...
export const BOSS_DEFEAT_BODY_DISAPPEAR_DELAY_MS = BOSS_DEFEAT_CLEAR_DELAY_MS;
export const BOSS_DEFEAT_SPRITE_DESTROY_DELAY_MS = BOSS_DEFEAT_BODY_DISAPPEAR_DELAY_MS;
